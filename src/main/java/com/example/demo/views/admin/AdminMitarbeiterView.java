...
// Description: Admin Mitarbeiter View 
...
@Route(value = "admin/mitarbeiter", layout = AdminLayout.class)

public class AdminMitarbeiterView extends VerticalLayout {

    private final AdminService adminService;
    private Grid<Mitarbeiter> mitarbeiterGrid;

    @Autowired
    public AdminMitarbeiterView(AdminService adminService) {
    ...
    private void updateGrid() {
        List<Mitarbeiter> mitarbeiter = adminService.alleMitarbeiterAbrufen();
    ...
    Button saveButton = new Button("Speichern", event -> {
        if (vornameField.isEmpty() || nachnameField.isEmpty() || geburtsdatumField.isEmpty() || adresseField.isEmpty() || telefonField.isEmpty()) {
            ...
            try {
                ...
                adminService.mitarbeiterHinzufuegen(neuerMitarbeiter);
    ...
    private void openEditMitarbeiterDialog(Mitarbeiter mitarbeiter) {
        ...
        Button saveButton = new Button("Änderungen speichern", event -> {
            ...
            try {
                ...
                adminService.mitarbeiterBearbeiten(mitarbeiter.getId(), mitarbeiter);
    ...
    private void openDeleteConfirmationDialog(Mitarbeiter mitarbeiter) {
        ...
        Button confirmButton = new Button("Löschen", event -> {
            try {
                adminService.mitarbeiterLoeschen(mitarbeiter.getId()); // Mitarbeiter löschen
