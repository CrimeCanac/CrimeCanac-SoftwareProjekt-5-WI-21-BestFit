...
public class AdminLayout extends AppLayout {
    ...
    private Div createHeader() {
        ...
        adminViewLabel.setText("Adminansicht");
    ...
    private Div createDrawer() {
        ...
        menu.add(createDrawerMenuItem("Mitglieder", "/admin/mitglieder"));
        menu.add(createDrawerMenuItem("Mitarbeiter", "/admin/mitarbeiter"));
        menu.add(createDrawerMenuItem("Geschäftsführer", "/admin/geschaeftsfuehrer"));
