...
// Description: Mitarbeiter Mitglied View 
...
@Route(value = "mitarbeiter/mitglieder", layout = EmployeeLayout.class)

public class EmployeeMitgliedView extends VerticalLayout {

    private final MitarbeiterService mitarbeiterService;
    private final Grid<Mitglied> mitgliedGrid;

    @Autowired
    public EmployeeMitgliedView(MitarbeiterService mitarbeiterService) {
    ...
    private void updateGrid() {
        List<Mitglied> mitglieder = mitarbeiterService.alleMitgliederAbrufen();
        ...
        Button saveButton = new Button("Speichern", event -> {
            if (vornameField.isEmpty() || nachnameField.isEmpty()) {
                ...
                try {
                    ...
                    mitarbeiterService.mitgliedHinzufuegen(neuesMitglied);
    ...
    private void openEditMitgliedDialog(Mitglied mitglied) {
        ...
        Button saveButton = new Button("Änderungen speichern", event -> {
            ...
            try {
                ...
                mitarbeiterService.mitgliedBearbeiten(mitglied.getId(), mitglied);
    ...
    private void openDeleteConfirmationDialog(Mitglied mitglied) {
        ...
        Button confirmButton = new Button("Löschen", event -> {
            try {
                mitarbeiterService.mitgliedLoeschen(mitglied.getId());
                updateGrid();
