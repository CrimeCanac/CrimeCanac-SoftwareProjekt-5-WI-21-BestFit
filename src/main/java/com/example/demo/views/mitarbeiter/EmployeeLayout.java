...
public class EmployeeLayout extends AppLayout {
    ...
    private Div createHeader() {
        ...
        Div employeeViewLabel = new Div();
        employeeViewLabel.setText("Mitarbeiter-Ansicht");
        employeeViewLabel.addClassName("admin-view-label"); // Optional: CSS-Klasse für Styling
        ...
        HorizontalLayout headerLayout = new HorizontalLayout(hamburgerMenuButton, logo, employeeViewLabel, logoutButton);
    ...
    private Div createDrawer() {
        ...
        menu.add(createDrawerMenuItem("Mitglieder", "/mitarbeiter/mitglieder"));
