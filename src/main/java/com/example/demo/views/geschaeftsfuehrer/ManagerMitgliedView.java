...
// Description: Geschäftsführer Mitglied View 
...
@Route(value = "manager/mitglieder", layout = ManagerLayout.class)
public class ManagerMitgliedView extends VerticalLayout {

    private final GeschaeftsfuehrerService geschaeftsfuehrerService;
    private final Grid<Mitglied> mitgliedGrid;

    @Autowired
    public ManagerMitgliedView(GeschaeftsfuehrerService geschaeftsfuehrerService) {
    ...
    private void updateGrid() {
        List<Mitglied> mitglieder = geschaeftsfuehrerService.alleMitgliederAbrufen();
        ...
        Button saveButton = new Button("Speichern", event -> {
            if (vornameField.isEmpty() || nachnameField.isEmpty()) {
                ...
                try {
                    ...
                    geschaeftsfuehrerService.mitgliedHinzufuegen(neuesMitglied);
    ...
    private void openEditMitgliedDialog(Mitglied mitglied) {
        ...
        Button saveButton = new Button("Änderungen speichern", event -> {
            ...
            try {
                ...
                geschaeftsfuehrerService.mitgliedBearbeiten(mitglied.getId(), mitglied);
    ...
    private void openDeleteConfirmationDialog(Mitglied mitglied) {
        ...
        Button confirmButton = new Button("Löschen", event -> {
            try {
                geschaeftsfuehrerService.mitgliedLoeschen(mitglied.getId());
                updateGrid();
